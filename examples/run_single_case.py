...
def main():
    ...
    try:
        ...
        optimizer = LayoutOptimizationRandomSearchLowRank(
            ...
            adaptive_fill_strategy=eval_cfg["adaptive_fill_strategy"],
            reuse_stage1_overlap=eval_cfg["reuse_stage1_overlap"],
        )
        ...
        result = {
            ...
            "objective_final": objective_final,  # backward-compatible search value
            "objective_final_search": optimizer.objective_final_search,
            "objective_final_exact": optimizer.objective_final_exact,
        ...
        print(f"Final search objective : {optimizer.objective_final_search / 1e9:.6f} GWh")
        print(f"Final Exact AEP        : {optimizer.objective_final_exact / 1e9:.6f} GWh")
