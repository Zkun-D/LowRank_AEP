...
def load_config(file_path: str) -> dict:
    ...
    config = {
        ...
        "evaluator": {
            ...
            "adaptive_fill_strategy": _parse_str(raw.get("adaptive_fill_strategy", "maximin")).lower(),
            "reuse_stage1_overlap": _parse_bool_flag(raw.get("reuse_stage1_overlap", 1), default=True),
        },
        "wind": {
    ...
    if config["evaluator"]["adaptive_fill_strategy"] not in {"maximin", "energy"}:
